...
# Potential Use of MapView for Mapping
...
at_10 = lattice::do.breaks(endpoints = c(0, 100), nint = 10)
mapview(indata, zcol="Result_NoW.1", legend = TRUE, layer.name = 'sMCDA Result',col.regions = palfunc, at = at_10)
