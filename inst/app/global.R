...
# Resolve static asset path for both app-dir and package-driven runs
asset_prefix <- Sys.getenv("SMCDA_ASSET_PREFIX", unset = "")
asset_logo <- if (nzchar(asset_prefix)) paste0(asset_prefix, "/psi.png") else "psi.png"
